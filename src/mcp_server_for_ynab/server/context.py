...
from mcp_server_for_ynab.auth.pat import PatAuthProvider
from mcp_server_for_ynab.config.settings import ConfigError, Settings
...
_request_app_context: ContextVar[AppContext | None] = ContextVar(
    "mcp_server_for_ynab_request_app_context", default=None
)
