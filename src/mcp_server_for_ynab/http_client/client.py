...
class YnabHttpClient:
    ...
    def __init__(self, auth_provider: AuthProvider, budget: RateBudget | None = None) -> None:
        ...
        *,
        ...
        for attempt in range(_MAX_RETRIES + 1):
            if self.budget.remaining() == 0:
                raise YnabMcpException(YnabMcpError.rate_limited(retry_after=self.budget.seconds_until_next_slot()))
